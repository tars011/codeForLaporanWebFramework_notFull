...
<h1>Barang Keluar</h1>
<div class="aksi">
    <a href="{{ route('item_outs.create') }}" class="button button-blue"><i class="fa-regular fa-square-plus"></i>Tambah Barang</a>
</div>
<table id="item_outs-table" class="display" style="width:100%">
    <thead>
        <tr>
            <th>#</th>
            <th>Kode Barang</th>
...
@section('content-js')
    ...
    <script>
        $(document).ready(function() {
            $('#item_outs-table').DataTable({
                processing: true,
                serverSide: true,
                ajax: '{{ route("item_outs.index") }}',
                language: 
                {
